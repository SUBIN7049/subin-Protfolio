                  ...
                  <div class="flex-item"><a href="${pageContext.request.contextPath}/detail?productNum=${productlist.product_num}">
                     ...
                     <br>
                            ...
                            <p style="font-size:14px;">
                               ...
                               <span class="badge badge-danger">30%할인</span>    <fmt:formatNumber type="number" maxFractionDigits="3" value="${productlist.product_price*productlist.product_score}" />원<br>
